...
export class InitialMigration1718267001155 implements MigrationInterface {
    name = 'InitialMigration1718267001155'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "files" ("id" BIGSERIAL NOT NULL, "path" character varying NOT NULL, CONSTRAINT "PK_6c16b9093a142e0e7613b04a3d9" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "companies" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "country" character varying NOT NULL, "businessSector" character varying NOT NULL, "productsAndServices" character varying NOT NULL, "registrationStructure" character varying NOT NULL, "yearsOfOperation" integer NOT NULL, "growthStage" character varying NOT NULL, "numberOfEmployees" integer NOT NULL, "fullTimeBusiness" boolean NOT NULL, "userId" integer, "companyLogoId" bigint, CONSTRAINT "REL_6d64e8c7527a9e4af83cc66cbf" UNIQUE ("userId"), CONSTRAINT "REL_eb06a09af4bf21ea7f413aea1c" UNIQUE ("companyLogoId"), CONSTRAINT "PK_d4bc3e82a314fa9e29f652c2c22" PRIMARY KEY ("id"))`);
