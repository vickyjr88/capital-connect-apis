...
export class CompanyEnumTypeFeatureV21719479892687 implements MigrationInterface {
    name = 'CompanyEnumTypeFeatureV21719479892687'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."companies_yearsofoperation_enum" AS ENUM('0 years', '0 - 1 years', '2 - 3 years', '3 - 5 years', '5 - 8 years', 'More than 8 years')`);
        await queryRunner.query(`ALTER TABLE "companies" ADD "yearsOfOperation" "public"."companies_yearsofoperation_enum" NOT NULL DEFAULT '0 years'`);
        await queryRunner.query(`CREATE TYPE "public"."companies_numberofemployees_enum" AS ENUM('1-10 employees', '11-50 employees', '51-200 employees', '201-500 employees', '501-1000 employees', '1001-5000 employees', '5001-10000 employees', '10001+ employees')`);
        await queryRunner.query(`ALTER TABLE "companies" ADD "numberOfEmployees" "public"."companies_numberofemployees_enum" NOT NULL DEFAULT '1-10 employees'`);
    }
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP TYPE "public"."companies_yearsofoperation_enum"`);
