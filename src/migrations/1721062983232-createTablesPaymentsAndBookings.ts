...
export class CreateTablesPaymentsAndBookings1721062983232 implements MigrationInterface {
    name = 'CreateTablesPaymentsAndBookings1721062983232'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "booking" ("id" SERIAL NOT NULL, "calendlyEventId" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "userId" integer, CONSTRAINT "PK_49171efc69702ed84c812f33540" PRIMARY KEY ("id"))`);
